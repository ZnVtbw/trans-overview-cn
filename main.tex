...
\begin{document}
	...
	\section{The medical resources}
		...
		\begin{figure}[t]
			...
			\begin{minipage}{0.45\linewidth}
				...
				\caption{Androcur (cyproterone acetate) 50 mg oral tablets in Taiwan}\label{med:anti}
			\end{minipage}
			\qquad
			\begin{minipage}{0.45\linewidth}
				\centering
	...
	This study is driven by academic interest in the topic and was conceived and completed by the author independently without any supervision from others.
	...
	The author also wants to appreciate Wikimedia Commons and JAMA Network Open for giving free repositories to the author for finding related resources about transgender in Mainland China.
